...
<p><strong>Professor: Architect Jaime Alberto Gutiérrez Mejía. <?php echo date("Y"); ?></strong></p>
    ...
    <p>
    <form id="formularioEmpleado" name="formularioEmpleado" 
     method="post" action="controladores/ControladorEmpleado.php"
     onsubmit="return validarEnvio()">
      ...
      <table id="tabla" cellpadding="0" cellspacing="0" border="1">
          ...
          <tr>
              <td>Apellido:</td>
              <td>
                <input type="text" id="apellido" name="apellido" size="40"/>
              </td>
          </tr>
          <tr>
              <td>Salario:</td>
              <td>
                <div id="staticParent">
                 <input type="textarea" id="salario" name="salario" size="30"/>
                </div>
              </td>
          </tr>
          <tr>
